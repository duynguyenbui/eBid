...
public sealed class AuctionIntegrationEventService(ILogger<AuctionIntegrationEventService> logger,
    IEventBus eventBus,
    AuctionContext catalogContext,
    IIntegrationEventLogService integrationEventLogService)
    : IAuctionIntegrationEventService, IDisposable
{
