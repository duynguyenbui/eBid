...
global using eBid.Identity.API;
global using eBid.Identity.API.Configuration;
global using eBid.Identity.API.Data;
global using eBid.Identity.API.Models;
global using eBid.Identity.API.Services;
global using eBid.Identity.API.Models.AccountViewModels;
